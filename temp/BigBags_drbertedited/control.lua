...
local function on_configuration_changed(data)
	...
	if data.mod_changes ~= nil then
		...
		if changes ~= nil then
			...
			if changes.old_version and older_version(changes.old_version, "1.0.21") then
				for _,force in pairs(game.forces) do
					force.reset_technologies()
					force.reset_recipes()
					...
					force.technologies["inventory-size"].researched = false
					force.technologies["inventory-size-2"].researched = false
					force.technologies["inventory-size-3"].researched = false
					force.technologies["inventory-size-4"].researched = false
					force.technologies["inventory-size-5"].researched = false
					force.technologies["pickstick"].researched = false
					force.technologies["pickstick-2"].researched = false
					force.technologies["pickstick-3"].researched = false
					force.technologies["pickstick-4"].researched = false
					force.technologies["pickstick-5"].researched = false
